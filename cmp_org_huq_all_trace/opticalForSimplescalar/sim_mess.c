...
void packet_spend(int src, int a, counter_t sim_cycle)
{
	...
	switch(dis)
	{
	case 0: dist_bin[19] ++; break;
	case 1: dist_bin[0] ++; break;
	case 2: dist_bin[1] ++; break;
	case 3: dist_bin[2] ++; break;
	case 4: dist_bin[3] ++; break;
	case 5: dist_bin[4] ++; break;
	case 6: dist_bin[5] ++; break;
	case 7: dist_bin[6] ++; break;
	case 8: dist_bin[7] ++; break;
	case 9: dist_bin[8] ++; break;
	case 10: dist_bin[9] ++; break;
	case 11: dist_bin[10] ++; break;
	case 12: dist_bin[11] ++; break;
	case 13: dist_bin[12] ++; break;
	case 14: dist_bin[13] ++; break;
	case 15: dist_bin[14] ++; break;
	case 16: dist_bin[15] ++; break;
	case 17: dist_bin[16] ++; break;
	case 18: dist_bin[17] ++; break;
	default: dist_bin[18] ++;
	}
