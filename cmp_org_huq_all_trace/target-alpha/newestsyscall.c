 ...
 *
 * $Id: newestsyscall.c,v 1.1.1.1 2011/03/29 01:04:35 huq Exp $
 *
 * $Log: newestsyscall.c,v $
...
/* #endif */
	...
	switch( table_id )
	{
	  case OSF_TBL_SYSINFO:
		...
		regs->regs_R[MD_REG_A3] = -1;
		regs->regs_R[MD_REG_V0] = errno; /* -- Not kosher to pass off errno of getrusage()
		...
		break;
	      ...
	      mem_bcopy(mem_fn, mem, Write, buf_addr, &sysinfo, sizeof(struct osf_tbl_sysinfo));
